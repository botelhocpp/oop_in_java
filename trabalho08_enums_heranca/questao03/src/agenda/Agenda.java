 ...
 * 
 * 10/12/2021 - Implementação dos métodos.
 * 11/12/2021 - Construtor sobrecarregado para melhor
 * compatibilidade com classes herdeiras, com o tamanho
 * especificado, assim com um atributo "size" e um getter
 * para ele. O método findPosByName() foi alterado para
 * protected para melhor compatibilidade com as classes
 * herdeiras.
 * 
...
public class Agenda {
    ...
    /**
     * Encapsula o tamanho da lista de contatos. Usado
     * apenas para compatibilidade com classes herdeiras
     * que queiram limitar a quantidade de contatos,
     * devido à classe ArrayList ter tamanho ajustável.
     */
    private int size;
    ...
    /**
     * Inicializa a instância da agenda, inicializando 
     * a lista de contatos com um tamanho "size".
     * 
     * @param size Tamanho da lista de contatos.
     * @throws IllegalArgumentException caso o tamanho
     * informado seja inválido.
     */
    public Agenda(int size){
        if(size < 0){
            throw new IllegalArgumentException("fail: valor para tamanho da lista inválido.");
        }
        else{
            this.size = size;
            this.contacts = new ArrayList<Contact>(size); 
        }
    }
    ...
    public Contact findContact(String name){
        ...
        if(index < 0){
            System.err.println("warning: nenhum resultado encontrado para " + name);
            return null;
        }
        else{
     ...
     */
    protected int findPosByName(String name){
